...
```{r mass model}
load(file = "/Users/kaitlyn.campbell/OneDrive - The University of South Dakota/Dissertation/Chapter4_Brains_IMI/Field/Bayes_code/saved_models/m_mass1.1.rda")
...
mu_mass %>%
  ...
  geom_point(data = bo, aes(x=type2, y=Body_mass_g, fill= type2), position = position_jitterdodge(seed = 1, dodge.width =0.9)) +
  labs(x = "Wetland Type", 
       y = "Body Mass (g)",
       fill= "Wetland Type") +
  theme(text= element_text(size=20), plot.title = element_text(face = "bold"), plot.caption = element_text(size=10)) +
  theme_classic() + theme(plot.caption = element_text(hjust = 0, size=8)) +
...
##### TL ##### 
```{r m_tl5_mm model}
load(file = "/Users/kaitlyn.campbell/OneDrive - The University of South Dakota/Dissertation/Chapter4_Brains_IMI/Field/Bayes_code/saved_models/m_tl5_mm.rda")
